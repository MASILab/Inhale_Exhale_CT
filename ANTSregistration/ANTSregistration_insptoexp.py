...
def register_with_mask_insptoexp_non_harmonized():
    """
    Register inspiratory to expiratory images using the masks for harmonized and non harmonized images. Compute JD and Log JD"
    """
    #Non harmonzied masks
    bone_non_harm_mask = "/nfs/masi/krishar1/SPIE_2025_InhaleExhaleCT/data_split/lungmasks/inference_resampled_lung_masks/inspiratory_BONE"
    std_non_harm_mask = "/nfs/masi/krishar1/SPIE_2025_InhaleExhaleCT/data_split/lungmasks/inference_resampled_lung_masks/expiratory_STANDARD"
    ...
    out_non_harmonized = "/nfs/masi/krishar1/SPIE_2025_InhaleExhaleCT/data_split/registration_data/non_harmonized/SyN_registered_BONE_inspiratory_images_with_mask"

    jd_non_hamrm = "/nfs/masi/krishar1/SPIE_2025_InhaleExhaleCT/data_split/registration_data/non_harmonized/jacobian_determinant_images_insptoexp_withmask"
    log_jd_non_harm = "/nfs/masi/krishar1/SPIE_2025_InhaleExhaleCT/data_split/registration_data/non_harmonized/log_jacobian_determinant_images_insptoexp_withmask"

    bone_non_harm_masks_files = sorted(os.listdir(bone_non_harm_mask))
    std_non_harm_masks_files = sorted(os.listdir(std_non_harm_mask))
    ...
    for i in tqdm(range(len(bone_non_harm_files))):
        ...
        bone_non_harm_mask_file = os.path.join(bone_non_harm_mask, bone_non_harm_masks_files[i])
        std_non_harm_mask_file = os.path.join(std_non_harm_mask, std_non_harm_masks_files[i])
        ...
        bone_non_harm_mask_img = ants.image_read(bone_non_harm_mask_file)
        std_non_harm_mask_img = ants.image_read(std_non_harm_mask_file)

        #Run the registration
        reg = ants.registration(fixed = std_non_harm_img, moving = bone_non_harm_img, type_of_transform = 'SyN', mask = std_non_harm_mask_img, moving_mask=bone_non_harm_mask_img, mask_all_stages=True)
...
def register_with_mask_harmonized():
    bone_harm_mask = "/nfs/masi/krishar1/SPIE_2025_InhaleExhaleCT/data_split/lungmasks/resampled_harmonized_BONE_lung_masks"
    std_non_harm_mask = "/nfs/masi/krishar1/SPIE_2025_InhaleExhaleCT/data_split/lungmasks/inference_resampled_lung_masks/expiratory_STANDARD"

    std_non_harmonized = "/nfs/masi/krishar1/SPIE_2025_InhaleExhaleCT/data_split/registration_data/non_harmonized/resampled/resampled_masked_out_STANDARD"
    bone_harmonized = "/nfs/masi/krishar1/SPIE_2025_InhaleExhaleCT/data_split/registration_data/harmonized/resampled" 

    out_harmonized = "/nfs/masi/krishar1/SPIE_2025_InhaleExhaleCT/data_split/registration_data/harmonized/SyN_registered_BONE_inspiratory_images_with_mask"

    jd_harm = "/nfs/masi/krishar1/SPIE_2025_InhaleExhaleCT/data_split/registration_data/harmonized/jacobian_determinant_images_insptoexp_withmask"
    log_jd_harm = "/nfs/masi/krishar1/SPIE_2025_InhaleExhaleCT/data_split/registration_data/harmonized/log_jacobian_determinant_images_insptoexp_withmask"

    bone_harm_masks_files = sorted(os.listdir(bone_harm_mask))
    std_non_harm_masks_files = sorted(os.listdir(std_non_harm_mask))
    ...
    for i in tqdm(range(len(bone_harm_files))):
        ...
        std_non_harm_file = os.path.join(std_non_harm_files, std_non_harm_files[i])

        bone_harm_mask_file = os.path.join(bone_harm_mask, bone_harm_masks_files[i])
        std_non_harm_mask_file = os.path.join(std_non_harm_mask, std_non_harm_masks_files[i])
        ...
        #Run the registration
        reg = ants.registration(fixed = std_non_harm_img, moving = bone_harm_img, type_of_transform = 'SyN', mask = std_non_harm_mask_img, moving_mask=bone_harm_mask_img, mask_all_stages=True)
