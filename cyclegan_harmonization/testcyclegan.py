...
gen_dict = torch.load("/nfs/masi/krishar1/SPIE_2025_InhaleExhaleCT/experiments/inspiration_expiration_COPD/inspiration_expiration_COPD/latest_net_G_A.pth")
...
out_nii = os.path.join("/nfs/masi/krishar1/SPIE_2025_InhaleExhaleCT/experiments", "vanillacycleGAN")
